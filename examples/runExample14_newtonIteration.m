function runExample14_newtonIteration(degree,lim)
%runExample14_newtonIteration Runs the 2D gradient double pendulum [1-3] example to visualize the nonlinear balancing transformations.
%
%   Usage:  runExample14_newtonIteration(degree,lim)
%
