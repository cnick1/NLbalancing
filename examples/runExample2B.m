function [v, w] = runExample2B(degree, plotEnergy, plotBalancing, balancingDegree)
%runExample2B Runs the example from the paper
%
%   Usage:  [v,w] = runExample2B(degree,plotEnergy,plotBalancing,balancingDegree)
%
%   where
