function [f, g, h] = getSystem15(degree, n)
%getSystem15 Generates a polynomial approximation to an n mass spring
%damper system. The returned model is of size 2*n.
%
%   Usage:  [f,g,h] = getSystem15(degree, n)
%
%   References:
%
%%
...
filename = fullfile('examples', 'systemData', sprintf('system15_d=%i_n=%i.mat', degree, 2*n));
