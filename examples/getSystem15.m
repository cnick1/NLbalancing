function [f, g, h] = getSystem15(degree, model)
%getSystem15  Generates a polynomial approximation to the 4D model of a double pendulum.
%
%   Usage:  [f,g,h] = getSystem15(degree, relativeAngles)
%
