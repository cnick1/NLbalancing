function [f, g, h] = getSystem14(degree, relativeAngles)
...
if relativeAngles % define joint 2 angle relative to joint 1 angle, as in [1,2]
...
else % define positions from fixed vertical, see e.g. https://scienceworld.wolfram.com/physics/DoublePendulum.html
    % Using velocities as x3 and x4
