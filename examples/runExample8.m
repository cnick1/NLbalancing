function [v,w] = runExample8(degree,plotEnergy,plotBalancing,balancingDegree)
%EXAMPLE8 Runs the example from the paper
%
%   Usage:  [v,w] = runExample8(degree,plotEnergy,plotBalancing,balancingDegree)
%
%   where
