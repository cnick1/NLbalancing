function [A, B, C, N, f, g, h] = getSystem6(numElements, actuatorConfiguration, rotaryInertiaBool, varargin)
%getSystem6  Generates a cubic system for testing energy functions.
