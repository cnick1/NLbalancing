...
[Tscal, TscalInv] = scalingTransformation(sigmaSquared, degree=nvp.degree, r=nvp.r);
...
A = [1.*c(:,1).^(-1/4),...
    -(a(:,2).*c(:,1).^(-3/4)),...
    (2.*a(:,2).^2-a(:,1).*a(:,3)).*c(:,1).^(-5/4),...
    -((5.*a(:,2).^3-5.*a(:,1).*a(:,2).*a(:,3)+a(:,1).^2.*a(:,4)).*c(:,1).^(-7/4)),...
    1.*c(:,1).^(-9/4).*(14.*a(:,2).^4-21.*a(:,1).*a(:,2).^2.*a(:,3)+3.*a(:,1).^2.*a(:,3).^2+6.*a(:,1).^2.*a(:,2).*a(:,4)-a(:,1).^3.*a(:,5)),...
    1.*c(:,1).^(-11/4).*(-42.*a(:,2).^5+84.*a(:,1).*a(:,2).^3.*a(:,3)-28.*a(:,1).^2.*a(:,2).^2.*a(:,4)+7.*a(:,1).^2.*a(:,2).*(-4.*a(:,3).^2+a(:,1).*a(:,5))+a(:,1).^3.*(7.*a(:,3).*a(:,4)-a(:,1).*a(:,6))),...
    1.*c(:,1).^(-13/4).*(132.*a(:,2).^6-330.*a(:,1).*a(:,2).^4.*a(:,3)+120.*a(:,1).^2.*a(:,2).^3.*a(:,4)-36.*a(:,1).^2.*a(:,2).^2.*(-5.*a(:,3).^2+a(:,1).*a(:,5))+8.*a(:,1).^3.*a(:,2).*(-9.*a(:,3).*a(:,4)+a(:,1).*a(:,6))+a(:,1).^3.*(-12.*a(:,3).^3+8.*a(:,1).*a(:,3).*a(:,5)+a(:,1).*(4.*a(:,4).^2-a(:,1).*a(:,7)))),...
    1.*c(:,1).^(-15/4).*(-429.*a(:,2).^7+1287.*a(:,1).*a(:,2).^5.*a(:,3)-495.*a(:,1).^2.*a(:,2).^4.*a(:,4)+165.*a(:,1).^2.*a(:,2).^3.*(-6.*a(:,3).^2+a(:,1).*a(:,5))-45.*a(:,1).^3.*a(:,2).^2.*(-11.*a(:,3).*a(:,4)+a(:,1).*a(:,6))+3.*a(:,1).^3.*a(:,2).*(55.*a(:,3).^3-30.*a(:,1).*a(:,3).*a(:,5)+3.*a(:,1).*(-5.*a(:,4).^2+a(:,1).*a(:,7)))+a(:,1).^4.*(-45.*a(:,3).^2.*a(:,4)+9.*a(:,1).*a(:,3).*a(:,6)+a(:,1).*(9.*a(:,4).*a(:,5)-a(:,1).*a(:,8)))),...
    1*c(:,1).^(-17/4).*(1430.*a(:,2).^8-5005.*a(:,1).*a(:,2).^6.*a(:,3)+2002.*a(:,1).^2.*a(:,2).^5.*a(:,4)-715.*a(:,1).^2.*a(:,2).^4.*(-7.*a(:,3).^2+a(:,1).*a(:,5))+220.*a(:,1).^3.*a(:,2).^3.*(-13.*a(:,3).*a(:,4)+a(:,1).*a(:,6))-55.*a(:,1).^3.*a(:,2).^2.*(26.*a(:,3).^3-12.*a(:,1).*a(:,3).*a(:,5)+a(:,1).*(-6.*a(:,4).^2+a(:,1).*a(:,7)))+10.*a(:,1).^4.*a(:,2).*(66.*a(:,3).^2.*a(:,4)-11.*a(:,1).*a(:,3).*a(:,6)+a(:,1).*(-11.*a(:,4).*a(:,5)+a(:,1).*a(:,8)))+a(:,1).^4.*(55.*a(:,3).^4-55.*a(:,1).*a(:,3).^2.*a(:,5)+5.*a(:,1).*a(:,3).*(-11.*a(:,4).^2+2.*a(:,1).*a(:,7))+a(:,1).^2.*(5.*a(:,5).^2+10.*a(:,4).*a(:,6)-a(:,1).*a(:,9))))];
