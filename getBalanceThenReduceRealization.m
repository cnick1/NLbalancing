function [fbal,gbal,hbal,Tbal,sigmaSquared] = getBalanceThenReduceRealization(f,g,h,nvp)
%getBalanceThenReduceRealization Returns a balanced ROM for f,g,h in
%Kronecker polynomial form using balance THEN reduce
%
%   Usage: [fbal,gbal,hbal,Tbal,sigmaSquared] = getBalanceThenReduceRealization(f,g,h,r=r)
%
%   Inputs:
